  ...
  render() {
    ...
    return (
        <div className="voucher-wrapper">
          {this.state.isView &&
          <div className="voucher-detail-view"><img alt="" src={VoucherImage}/>
          </div>}
          {this.state.isActive &&
              ...
              <div className="inner">
                {
                  _.map(vouchers, voucher => {
                    if (voucher.id == 1 && this.state.isActive) {
                      return (
                          <div key={voucher.id} className="voucher-box-active">
                            ...
                            <div className="button">
                              <span onClick={this.handleView}>View <img alt=""
                                                                        src={BtnView}/></span><span>Download<img
                                alt="" src={BtnDown}/></span>
                            </div>
                          </div>);
                    }
                    return (<div key={voucher.id} className="voucher-box"
